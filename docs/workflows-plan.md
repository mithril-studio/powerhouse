...
1. **Implemented locally:** protocol-v3 script manifests, unprivileged shell execution, durable bounded output and exit results, cancellation/deadline handling, v2 agent compatibility and regression tests. Scripts never invoke a model or automatically publish Git changes.
